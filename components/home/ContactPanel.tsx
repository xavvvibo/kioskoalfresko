  ...
  return (
    <div className="grid gap-4 md:grid-cols-3">
      <article className="rounded-[1.75rem] border border-stone-950 bg-white p-6">
        ...
        <div className="mt-5"><ActionButton href={siteConfig.contact.phoneHref}>Llamar ahora</ActionButton></div>
      </article>
      <article className="rounded-[1.75rem] border border-stone-950 bg-[#d94b2b] p-6 text-white">
        ...
        <div className="mt-5"><ActionButton href={siteConfig.contact.whatsappUrl} kind="secondary" newTab>WhatsApp ahora</ActionButton></div>
      </article>
