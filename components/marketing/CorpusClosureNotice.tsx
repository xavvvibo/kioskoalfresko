...
export function CorpusClosureNotice() {
  return (
    <section className="rounded-[2rem] border border-stone-950 bg-[linear-gradient(180deg,#111111_0%,#1a1a1a_100%)] p-6 text-white shadow-[0_24px_60px_rgba(0,0,0,0.18)] md:p-8">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-3xl">
          <p className="text-[11px] font-black uppercase tracking-[0.22em] text-[#f2c6bb]">
            {corpusClosureNotice.eyebrow}
          </p>
          <h2 className="mt-3 text-[2rem] font-black uppercase leading-[0.92] tracking-[-0.05em] text-[#fff8ef] md:text-[3rem]">
