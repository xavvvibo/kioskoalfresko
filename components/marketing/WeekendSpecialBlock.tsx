...
export function WeekendSpecialBlock() {
  return (
    <section className="border-b border-stone-950 bg-[linear-gradient(180deg,#0a0a0a_0%,#141414_54%,#1b0905_100%)] py-8 text-white md:py-10">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="overflow-hidden rounded-[2.4rem] border border-white/10 bg-[radial-gradient(circle_at_top_right,rgba(217,75,43,0.24),transparent_20%),linear-gradient(180deg,rgba(255,255,255,0.03)_0%,rgba(255,255,255,0.01)_100%)] p-6 shadow-[0_28px_70px_rgba(0,0,0,0.24)] md:p-8">
          <div className="grid gap-6 lg:grid-cols-[1.08fr_0.92fr]">
            <div>
              <p className="text-[11px] font-black uppercase tracking-[0.22em] text-[#f2c6bb]">
                {specialWeekendCampaign.eyebrow}
              </p>
              <h2 className="mt-4 max-w-4xl text-[2.3rem] font-black uppercase leading-[0.92] tracking-[-0.05em] text-[#fff8ef] md:text-[4rem]">
            ...
            <div className="grid gap-4 self-stretch sm:grid-cols-2 lg:grid-cols-1">
              <article className="rounded-[1.7rem] border border-white/12 bg-[#d94b2b] p-5 text-white shadow-[0_16px_34px_rgba(217,75,43,0.18)]">
              ...
              {specialWeekendCampaign.schedule.map((item) => (
                <article key={item.day} className="rounded-[1.7rem] border border-white/12 bg-white/6 p-5">
                  ...
                  <h3 className="mt-3 text-xl font-black uppercase tracking-[-0.04em] text-[#fff8ef]">
                    {item.hours}
                  </h3>
                </article>
              ))}
