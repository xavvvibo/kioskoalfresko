...
const navGroups = [
  ...
  },
  {
    ...
    links: [
      ...
      ["Onboarding", "/admin-kiosko/personal/onboarding"],
      ["Offboarding", "/admin-kiosko/personal/offboarding"],
      ["Formación", "/admin-kiosko/personal/formacion"],
      ["PRL", "/admin-kiosko/personal/prl"],
      ["Material", "/admin-kiosko/personal/material"],
      ["Accesos", "/admin-kiosko/personal/accesos"],
      ["Checklists", "/admin-kiosko/personal/checklists"],
      ["Cumplimiento", "/admin-kiosko/personal/cumplimiento"],
