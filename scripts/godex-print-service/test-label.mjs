...
function testEzpl() {
  return [
    ...
    "^D0",
    "^L",
    "AA,16,18,1,2,2,0,0,KIOSKO ALFRESKO",
    "AA,16,52,1,1,1,0,0,TEST GODEX G500",
    "Lo,16,76,450,76,2",
    "AA,16,94,1,1,1,0,0,PRODUCTO: Etiqueta prueba",
    "AA,16,122,1,1,1,0,0,LOTE: TEST-GODEX-001",
    "AA,16,150,1,1,1,0,0,ELAB: 2026-07-03",
    "AA,16,178,1,1,1,0,0,CAD: 2026-07-05",
    "AA,16,214,1,1,1,0,0,RAW EZPL desde Windows Spooler",
    "BQ,330,96,2,4,80,0,0,TEST-GODEX-001",
    "E",
  ].join("\n");
}
